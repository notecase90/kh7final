...
<div class="container-fluid">
        ...
        <div class="jumbotron text-center mt-3">
            <h1 style="word-break: keep-all;">받은 인증번호를 다시 확인하시고 인증번호를 입력 해주세요</h1>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-md-6 offset-sm-3">
                ...
                <form action="certNo" method="post" class="form">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input type="text" name="emailNo"placeholder="인증번호" class="form-control" required autocomplete="off">
                    </div>

                    <div class="btn-box">
                        <button type="reset" class="btn btn-secondary ">Reset</button>
                        <input type="submit" class="btn btn-primary " value="인증 확인">
                    </div>
