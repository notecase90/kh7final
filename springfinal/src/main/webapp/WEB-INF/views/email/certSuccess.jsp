...
%>
    ...
    <div class="container-fluid">
        ...
        <div class="jumbotron text-center mt-3">
            <h1 style="word-break: keep-all; font-weight: bold;">인증성공</h1>
        </div>
            ...
            <div class="col-md-6 offset-sm-3">
                ...
                <form action="${root}" method="post" class="form">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input type="text" name="hostIntro"placeholder="한줄 소개" class="form-control" required autocomplete="off">
                    </div>

                    <div class="btn-box">
                        <button type="reset" class="btn btn-secondary ">Reset</button>
                        <input type="submit" class="btn btn-primary " value="호스트페이지이동">
                    </div>
