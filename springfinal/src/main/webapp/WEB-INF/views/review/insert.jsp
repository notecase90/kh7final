...
#star-box{
    ...
    <div class="container-fluid">
        ...
        <div class="jumbotron text-center mt-3">
            <h1 style="word-break: keep-all;">호스트를 위해 리뷰를 작성해주세요!</h1>
	...
	<div id="star-box">
		...
		<img src="${root}/resources/img/star-off.png" style="width:30px;height:30px;" id="star5" class="star">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input type="text" name="reviewContent"placeholder="리뷰를 남겨주세요" class="form-control" required autocomplete="off">
