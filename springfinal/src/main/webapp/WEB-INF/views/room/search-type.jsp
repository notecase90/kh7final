...
<div class="content">
	<div class="list">	
		...
		<c:forEach var="alltypeSearchVo" items="${search}" varStatus="status">
			<div class="roombox">
				<input type="hidden" value="${alltypeSearchVo.roomAdd}">
				<div class="img">
					<a href="${root}/room/detail/${alltypeSearchVo.roomNo}" style="text-decoration: none;color: black;">
						<img class="preview" src="${root}/data/room/download/${roomPicNo[status.index]}">	
					</a>		
				</div>
				<div class="roomInfo">
					<a href="${root}/room/detail/${alltypeSearchVo.roomNo}" style="text-decoration: none;color: black;font-size: 22px;">
						${alltypeSearchVo.roomName}</a>
					<div style="margin-top: 10px; margin-bottom: 10px;height: 1px;width: 30px;">
						<div style="border-bottom-width: 1px; border-bottom-color: rgb(235,235,235); border-bottom-style: solid;">	
						</div>
					</div>	
					
					<a href="${root}/room/detail/${alltypeSearchVo.roomNo}" style="text-decoration: none;color: black;font-weight: 200;font-size: 14px;">
						${alltypeSearchVo.roomAdd}<br>
					</a>
					<a href="${root}/room/detail/${alltypeSearchVo.roomNo}" style="text-decoration: none;color: black;font-weight: 200;font-size: 14px;">
						침실 ${alltypeSearchVo.bedCount}개 · 욕실 ${alltypeSearchVo.bathCount}개 · 발코니 ${alltypeSearchVo.balconyCount}개
					</a>
				</div>	
			</div>
